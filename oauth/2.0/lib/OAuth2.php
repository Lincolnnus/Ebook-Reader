...
class OAuth2 {
	...
	const DEFAULT_AUTH_CODE_LIFETIME = 3000;
	...
	protected function setDefaultOptions() {
		$this->conf = array(
			...
			self::CONFIG_SUPPORTED_SCOPES => array('basic','user','history') // This is expected to be passed in on construction. Scopes can be an aribitrary string.
		);  
	}
